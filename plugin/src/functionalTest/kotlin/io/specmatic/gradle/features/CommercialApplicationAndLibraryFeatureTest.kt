...
class CommercialApplicationAndLibraryFeatureTest : AbstractFunctionalTest() {
    ...
    inner class RootModuleOnly {
        ...
        val allObfuscatedPublishedArtifacts =
            arrayOf(
                publishedArtifact("io.specmatic.example:example-project-all:1.2.3", OBFUSCATED_FAT),
                publishedArtifact("io.specmatic.example:example-project:1.2.3", OBFUSCATED_SLIM),
            )
        ...
        inner class WithMavenCentralPublishing {
            ...
            fun `when publishing to maven central publishes sources as well`() {
                ...
                assertPublishedWithSourcesAndJavadocs(*allObfuscatedPublishedArtifacts)
    ...
    inner class MultiModuleOnly {
        ...
        val obfuscatedPublishedArtifacts =
            arrayOf(
                publishedArtifact("io.specmatic.example:executable-all:1.2.3", OBFUSCATED_FAT),
                publishedArtifact("io.specmatic.example:executable:1.2.3", OBFUSCATED_SLIM),
